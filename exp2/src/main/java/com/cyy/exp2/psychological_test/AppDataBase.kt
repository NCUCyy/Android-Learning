...
import com.cyy.exp2.psychological_test.dao.RecordDao
import com.cyy.exp2.psychological_test.dao.UserDao
import com.cyy.exp2.psychological_test.pojo.Converters
        ...
        fun getDatabase(context: Context): AppDataBase {
            return INSTANCE ?: synchronized(this) {
                val dataBase = Room.databaseBuilder(
                    ...
                    AppDataBase::class.java, "psy-4-right-wrong-undo"
                )
                    .build()
                INSTANCE = dataBase
                dataBase
